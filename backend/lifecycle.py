    ...
    async def _create():
        try:
            ...
            indexes = [
                ...
                ("storage_facilities", [("owner_user_id", ASCENDING)], "idx_storage_fac_owner", False),
                ("storage_facilities", [("status", ASCENDING)], "idx_storage_fac_status", False),
                ("storage_facilities", [("province", ASCENDING)], "idx_storage_fac_province", False),
                ("storage_auctions", [("status", ASCENDING), ("end_time", ASCENDING)], "idx_storage_auc_status_end", False),
                ("storage_auctions", [("facility_id", ASCENDING), ("status", ASCENDING)], "idx_storage_auc_fac_status", False),
                ("storage_auctions", [("facility_province", ASCENDING), ("status", ASCENDING)], "idx_storage_auc_prov_status", False),
                ("storage_auctions", [("winning_bidder_id", ASCENDING)], "idx_storage_auc_winner", False),
