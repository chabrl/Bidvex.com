...
<p style="margin:0 0 6px;font-family:{FONT};font-size:12px;color:rgba(255,255,255,0.5);"><a href="mailto:service@bidvex.com" style="color:{C['sky']};text-decoration:none;" clicktracking=off>service@bidvex.com</a></p>
