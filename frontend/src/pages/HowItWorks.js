  ...
  const sections = [
    ...
    },
    {
      ...
      steps: [
        ...
        { icon: <Users className="h-5 w-5" />,       en: 'Find a licensed broker. Canadian law requires a licensed dealer to bid at wholesale vehicle auctions. Browse our verified broker directory and choose one in your province.', fr: 'Trouvez un courtier licencié. La loi canadienne exige qu\'un concessionnaire licencié enchérisse aux enchères de véhicules en gros. Parcourez notre répertoire et choisissez-en un dans votre province.' },
        { icon: <CreditCard className="h-5 w-5" />,  en: 'Request a partnership. A $500 refundable security deposit is held (not charged) on your card as a good-faith commitment. Released after vehicle handoff.', fr: 'Demandez un partenariat. Une caution de 500 $ remboursable est retenue (non débitée) sur votre carte en gage de bonne foi. Libérée après la remise du véhicule.' },
        ...
        { icon: <Star className="h-5 w-5" />,        en: 'Auction closes — invoice generated. If your broker wins, BidVex instantly generates a detailed invoice showing exactly what you owe and to whom.', fr: 'L\'enchère ferme — la facture est générée. Si votre courtier gagne, BidVex génère instantanément une facture détaillée.' },
        ...
        { icon: <Truck className="h-5 w-5" />,       en: 'Pick up your vehicle. Once your broker confirms full payment received, you get an 8-character pickup code. Show it at the seller\'s location with your ID. The vehicle is yours.', fr: 'Récupérez votre véhicule. Une fois que votre courtier confirme le paiement complet, vous recevez un code de retrait de 8 caractères. Présentez-le sur place avec votre pièce d\'identité.' },
      ],
    ...
    <div className="min-h-screen" data-testid="how-it-works-page">
      ...
      <section className="relative py-20 px-4 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <LangLink to="/auth" onClick={() => trackCTA('hero_signup', 'hero', 'Create Free Account')}>
            ...
            <LangLink to="/marketplace" onClick={() => trackCTA('hero_browse', 'hero', 'Browse Marketplace')}>
              ...
              <CardContent className="p-6">
                ...
                {section.cta && (
                  <div className="mt-6 pt-4 border-t">
                    <LangLink to={section.cta.href} onClick={() => trackCTA('section_cta_click', section.id, section.cta.label)}>
      ...
      <section className="py-16 px-4 bg-gradient-to-br from-slate-900 to-slate-800 text-white text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <LangLink to="/create-listing" onClick={() => trackCTA('final_sell', 'final_cta', 'Start Selling')}>
            ...
            <LangLink to="/marketplace" onClick={() => trackCTA('final_bid', 'final_cta', 'Start Bidding')}>
            ...
            <LangLink to="/become-a-partner" onClick={() => trackCTA('final_partner', 'final_cta', 'Apply as Partner')}>
