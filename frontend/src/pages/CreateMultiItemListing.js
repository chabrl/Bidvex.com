...
const CreateMultiItemListing = () => {
  ...
  return (
    <div className=\"min-h-screen py-8 px-4\" data-testid=\"create-multi-item-listing\">
      <div className=\"max-w-5xl mx-auto\">
        <Card className=\"glassmorphism\">
          <CardHeader>
            <CardTitle className=\"text-2xl font-bold\">Create Multi-Item Listing (Business)</CardTitle>
            <p className=\"text-muted-foreground\">Create a grouped auction with multiple lots</p>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className=\"space-y-8\">
              <div className=\"space-y-4\">
                ...
                <div className=\"space-y-2\">
                  ...
                  <Input
                    ...
                    placeholder=\"e.g., Subway Bankruptcy Restaurant Equipment\"
                    required
                  />
                </div>
                      ...
                      <div className=\"space-y-2\">\n                        <Label>Images</Label>
                        ...
                        {lot.images.length > 0 && (
                          <div className=\"grid grid-cols-3 gap-2 mt-2\">\n                            {lot.images.map((img, imgIndex) => (
                              <div key={imgIndex} className=\"relative aspect-square rounded-lg overflow-hidden bg-gray-100\">\n                                <img src={img} alt={`Lot ${index + 1} preview ${imgIndex + 1}`} className=\"w-full h-full object-cover\" />
                                <button
                                  type=\"button\"
                                  onClick={() => removeLotImage(index, imgIndex)}
              ...
              <Button
                ...
                disabled={loading}
              >\n                {loading ? <><Loader2 className=\"mr-2 h-4 w-4 animate-spin\" /> Creating...</> : 'Create Multi-Item Listing'}\n              </Button>
            </form>
          </CardContent>
        </Card>
      </div>
