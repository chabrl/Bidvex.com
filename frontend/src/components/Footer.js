      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div data-testid="footer-col-support">
            ...
            <ul className="space-y-1.5 text-sm">
              <li><a href="mailto:service@bidvex.com" className="hover:text-white transition-colors flex items-center gap-1.5" data-testid="footer-email-support">
              ...
              <li><a href="mailto:service@bidvex.com?subject=Dispute%20Resolution" className="hover:text-white transition-colors" data-testid="footer-disputes">
                {language === 'fr' ? 'Résolution des différends' : 'Dispute Resolutions'}
              </a></li>
              <li><a href="mailto:service@bidvex.com?subject=Legal%20%26%20Compliance" className="hover:text-white transition-colors" data-testid="footer-legal-inbox">
                {language === 'fr' ? 'Juridique et conformité' : 'Legal & Compliance'}
              </a></li>
              <li><a href="mailto:service@bidvex.com?subject=Broker%20%26%20Dealer" className="hover:text-white transition-colors" data-testid="footer-brokers-inbox">
