...
Password: Admin123!
URL:      https://visual-lab-7.preview.emergentagent.com
```
...
### Step 1: Login
1. Go to: `https://visual-lab-7.preview.emergentagent.com/auth`
2. Enter credentials:
   - Email: `admin@admin.bazario.com`
   - Password: `Admin123!`
3. Click "Login"
...
**Option 2: Direct URL**
- Navigate to: `https://visual-lab-7.preview.emergentagent.com/admin`
