...
Password: Admin123!
URL:      https://auction-hub-38.preview.emergentagent.com
```
...
### Step 1: Login
1. Go to: `https://auction-hub-38.preview.emergentagent.com/auth`
2. Enter credentials:
   - Email: `admin@admin.bazario.com`
   - Password: `Admin123!`
3. Click "Login"
...
**Option 2: Direct URL**
- Navigate to: `https://auction-hub-38.preview.emergentagent.com/admin`
